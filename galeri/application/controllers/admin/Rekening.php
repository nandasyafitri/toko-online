...
class Rekening extends CI_Controller {
	...
	public function tambah()
	{
		...
		$valid->set_rules('nama_pemilik', 'Nama Pemilik','required', array('required' => '%s Harus Diisi' ));

		$valid->set_rules('nomor_rekening', 'Nomor Rekening','required|is_unique[rekening.nomor_rekening]', array('required' => '%s Harus Diisi', 'is_unique' => '%s Nama Rekening sudah ada. Buat Nomor rekening baru' ));
