							...
							<ul class="header-cart-wrapitem">
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="<?php echo base_url('assets/upload/image/thumbs/'.$produknya->foto_produk) ?>" alt="<?php echo $keranjang['name'] ?>">
									</div>
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="<?php echo base_url('assets/upload/image/thumbs/'.$produk_mobile->foto_produk) ?>" alt="<?php echo $keranjang_mobile['name'] ?>">
									</div>
							...
							<div class="header-cart-buttons">
								...
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a href="<?php echo base_url('keranjang/checkout') ?>" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
										Check Out
									</a>
								</div>
							</div>
