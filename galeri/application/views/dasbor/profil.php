						...
						<table class="table">
							  <thead>
							    <tr>
							      ...
							      <th><input type="text" name="nama_pelanggan" class="form-control" placeholder="Nama Pelanggan" value="<?php echo $pelanggan->nama_pelanggan ?>" required></th>
							    </tr>
							  </thead>
							  <tbody>
							    <tr>
							    ...
							    <tr>
							      <td>Telepon</td>
							      <td><input type="text" name="telepon_pelanggan" class="form-control" placeholder="Telepon" value="<?php echo $pelanggan->telepon_pelanggan ?>" ></td>
							    </tr>
							    <tr>
							      <td>Alamat</td>
							    ...
							    <tr>
							      ...
							      <td> 
							      		<button class="btn btn-outline-success" type="submit">
							      			<i class="fa fa-save">		Update Profil</i>
							      		</button>
