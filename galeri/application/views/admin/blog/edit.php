	...
	<div class="card shadow mb-4 ">
		<div class="card-body">    
			<?php
				...
				//form open
				echo form_open_multipart(base_url('admin/blog/edit/' .$blog->id_blog));
			?>
		</div>
	</div>
</div>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
   <h1 class="h3 mb-0 text-gray-800"> <b> Edit Blog </b></h1>
 </div>
 ...
 <div class="card shadow mb-4 ">
 	...
 	<div class="card-body">
 		<div class="from-group row ">
		   ...
		   <div class="col-sm-10">
			<input type="text" name="judul" class="form-control" placeholder="judul" value="<?php echo 
			$blog->judul ?>" " required>
			</div>
		</div>
		<br>
