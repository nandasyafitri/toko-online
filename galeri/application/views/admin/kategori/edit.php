...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
   <h1 class="h3 mb-0 text-gray-800"> <b> Edit Kategori Produk </b></h1>
 </div>
 ...
 <div class="card shadow mb-4 ">
 	...
 	<div class="card-body">
		...
		<div class="from-group row ">
		   ...
		   <div class="col-sm-5">
			<input type="number" name="urutan" class="form-control" placeholder="Urutan" value="<?php echo 
			$kategori->urutan ?>" required>
			</div>
		</div>
		<br>
		...
		<div class="from-group row ">
		   ...
		   <div class="col-sm-5">
				...
				<a href="<?php echo base_url('admin/kategori') ?>" class="btn btn-outline-primary btn-sm">Kembali</a>
			</div>
		</div>
