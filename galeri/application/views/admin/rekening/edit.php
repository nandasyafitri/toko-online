...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
   <h1 class="h3 mb-0 text-gray-800"> <b> Edit Rekening  </b></h1>
 </div>
 ...
 <div class="card shadow mb-4 ">
 	...
 	<div class="card-body">
		...
		<div class="from-group row ">
		   ...
		   <div class="col-sm-5">
			<input type="number" name="nomor_rekening" class="form-control" placeholder="Nomor Rekening" value="<?php echo 
			$rekening->nomor_rekening ?>" required>
			</div>
		</div>
		<br>
		<div class="from-group row ">
